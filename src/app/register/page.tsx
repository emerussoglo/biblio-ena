...
export default function Register() {
  ...
  // Propositions de filières par établissement (utilisées pour les suggestions)
  ...
  // États du formulaire (les sélections deviennent des chaînes libres)
    ...
    try {
      const response = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...
          sex,
          phone,
          school: selectedEcole, // Envoie la valeur saisie ou choisie
          filiere,              // Envoie la valeur saisie ou choisie
          email,
          password,
        }),
      });
      ...
      // Redirection vers la page de connexion après 2 secondes d'affichage du succès
      setTimeout(() => {
        router.push("/login");
      }, 2000);
    ...
    <main className="auth-page">
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          {/* Établissement / École (Saisissable avec auto-complétion) */}
          <div className="form-group">
            ...
            <input 
              ...
              onChange={(e) => {
                ...
                setFiliere(""); // Reset la filière si l'école change
              }}
            />
  ...
  <option value="AUTRE Ecole" />
          ...
          {/* La Filière (Saisissable avec suggestions dynamiques basées sur l'école tapée) */}
          <div className="form-group">
          ...
          {/* CHAMP MOT DE PASSE SÉCURISÉ ET DYNAMIQUE */}
          <div className="form-group">
